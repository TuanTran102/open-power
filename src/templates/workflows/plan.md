...
1. **Load OpenSpec Change Proposal**:
   - Locate and read `.opow/changes/YYYY-MM-DD-<slug>/proposal.md`, `design.md`, and `specs/*.spec.md`.
...
2. **Deconstruct into Atomic Tasks & Align `tasks.md`**:
   ...
   - Synchronize and detail `.opow/changes/YYYY-MM-DD-<slug>/tasks.md`.
   - Map every task 1:1 to specific Acceptance Criteria from the Delta Specs.
   - **Save the plan to `.opow/plans/YYYY-MM-DD-<slug>.plan.md`** matching the change ID.
